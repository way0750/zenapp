...
function Calendar(jquery, dateObj) {
  ...
  this.currentMonthStr = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'][this.currentMonth - 1];
...
Calendar.prototype.makeBanner = function() {
  ...
  var $thisMonth = this.$('<h3 class="calendarCurrentMonth">' + this.currentYear + ': '+this.currentMonthStr + '</h3>');
...
Calendar.prototype.newMonth = function(amountToChange) {
  ...
  console.log(amountToChange, this.currentMonth, this.currentMonthStr);
};
